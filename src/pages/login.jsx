...
import { Mail, Lock, Github, CheckCircle ,Sun, Moon, Globe } from "lucide-react";
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className={`h-4 w-4 rounded ${
                      darkMode 
                        ? "bg-gray-700 border-gray-600 text-amber-500 focus:ring-amber-500" 
          ...
          <div className={`lg:w-1/2 rounded-2xl p-8 border transition-all duration-300 flex flex-col justify-center ${
            ...
            <div className="text-center">
              ...
              <p className={`mb-6 ${
                ...
                Access your personalized dashboard to track your project progress and explore new design ideas.
              </p>
